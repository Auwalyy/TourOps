  ...
  const columns: Column<any>[] = [
    ...
    },
    {
      ...
      render: (row) => {
        ...
        return <span className="font-medium text-neutral-900">{c?.fullName || `${c?.firstName} ${c?.lastName}`}</span>;
      },
    },
    {
      key: 'description',
      header: 'Description',
      render: (row) => <span className="text-sm text-neutral-600 line-clamp-1">{row.description}</span>,
    },
    {
      key: 'method',
      header: 'Method',
