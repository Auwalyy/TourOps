...
router.get('/overdue-installments', authorize('payments:read'), travelFileController.overdueInstallments);
...
router.get('/:id/payments', authorize('payments:read'), travelFileController.listPayments);
router.post('/:id/payments', authorize('payments:write'), travelFileController.addPayment);
router.put('/:id/payment-schedule', authorize('payments:write'), travelFileController.setPaymentSchedule);
